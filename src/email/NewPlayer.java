 ...
 * The Class NewPlayer.
 */
public class NewPlayer extends AbstractEmail{
	...
	void send() {
		...
		detail.add(opt);
		Email.send(emailManager.get(0), Email.Choise.NEW_PLAYER, detail);
		
	}
	
	/**
	 * Instantiates a new new player.
	 *
	 ...
	 */
	public NewPlayer(String usernamePlayer, String idCompetition, String manager, ArrayList<String> optional) {
