...
/**
 * The Class AdminCompetitions.
 */
public class AdminCompetitions extends JPanel {
	...
	/**
	 * Instantiates a new admin competitions.
	 */
	public AdminCompetitions() {
			...
			public void valueChanged(ListSelectionEvent e) {
				...
				try {
					textPane.setText("ID Competizione: \t" + comp.get(0).get(0)
							...
							+ comp.get(0).get(7) + "\nPrezzo: \t\t"
							+ comp.get(0).get(8) + "\nAttiva: \t\t"
							+ (comp.get(0).get(9).equals("1") ? "Sì" : "No"));
				} catch (SQLException e1) {
					// TODO Auto-generated catch block
				}
